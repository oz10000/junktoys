...
class TradeSummary:
    ...
    def _compute_summary(self):
        """Calcula todos los parámetros del trade"""
        # ===== INFORMACIÓN BÁSICA =====
        ...
        self.sl_pct = self.sl_mult * self.signal.atr_pct * 100
        ...
        self.tp_pct = self.tp_mult * self.signal.atr_pct * 100
    ...
    def _estimate_probability(self):
        """Estima la probabilidad de éxito basada en múltiples factores"""
        ...
        # Ajuste por soportes/resistencias
    ...
    def _get_edge_type(self):
        """Determina el tipo de edge basado en el score"""
        if self.score >= 0.70:
            return 'Máximo'
    ...
    def _get_entry_type(self):
        """Determina el tipo de entrada sugerido"""
    ...
    def _estimate_duration(self):
        """Estima la duración esperada de la operación"""
    ...
    def to_dict(self):
        """Convierte el resumen a diccionario para visualización"""
        return {
            # Información básica
            'symbol': self.symbol,
    ...
    def to_dataframe(self):
        """Convierte a DataFrame para mostrar en Streamlit"""
        data = self.to_dict()
        return pd.DataFrame([{
    ...
    def get_trailing_comparison(self):
        """Compara las dos estrategias de trailing"""
        return {
